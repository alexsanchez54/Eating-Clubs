...
plot_spring <-
  ...
  geom_point(size = 1) +
  geom_line() +
    geom_rect(data = alldata_summary |> filter(spring_break == 1),
            aes(xmin = infr_date - 0.5, xmax = infr_date + 0.5, ymin = 0, ymax = 40),
...
Shaded yellow regions below represent Spring Break, when less undergrads are on campus.
