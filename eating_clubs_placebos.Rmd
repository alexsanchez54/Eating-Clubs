...
for (j in 1:11) {
  ...
  for (i in 1:104) {
    ...
    #filter data
    # 31 days after Jan 1 (Apr 14) was the cutoff that had the highest Cohen's d when p < .05 in the OG data
...
```{r plotly1, echo=FALSE, fig.width=14, fig.height=3, fig.align='left'}
plotly1
```

```{r plotly2, echo=FALSE, fig.width=14, fig.height=3, fig.align='left'}
plotly2
```

```{r plotly3, echo=FALSE, fig.width=14, fig.height=7, fig.align='left'}
plotly3
```

```{r plotly4, echo=FALSE, fig.width=14, fig.height=50, fig.align='left'}
plotly4
```

```{r plotly5, echo=FALSE, fig.width=14, fig.height=50, fig.align='left'}
plotly5
```

```{r plotly6, echo=FALSE, fig.width=14, fig.height=50, fig.align='left'}
plotly6
```
